...
function Speciality({ title, image, color, type }) {
  ...
  return (
    <button
      ...
      } sm:w-40 w-20 sm:py-1 sm:space-y-5 space-y-2 rounded-2xl text-sm flex flex-col justify-center items-center font-semibold cursor-pointer px-1`}
    >
      <img src={image} alt={title} className="sm:w-17 sm:h-18 w-10 h-8 mt-4" />
